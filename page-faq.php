...
//trace(substr(strrchr('#', $_SERVER['REQUEST_URI']), 1));
    ...
    <div id="main" role="main" class="clearfix <? echo get_page_name();?>">
		...
		<div class="columns clearfix">
			...
			<article class="content left">
				<figure>
					<img src="<? echo get_bloginfo("stylesheet_directory") ?>/images/faq1.png" alt="Golden Eye" />
				</figure>

				<dl id="freq">
					
					<dt id="hotel"><span>Hotel Information</span></dt>

					<dd>
						<figure class="right dir">
							<img src="<? echo get_bloginfo("stylesheet_directory") ?>/images/faq13.jpg" alt="Golden Eye"/>	
						</figure>

						<h3>What time is check-in? Checkout?</h3>
						<p>Check-in is at 3 p.m. Checkout is at noon. We do everything possible to accommodate early arrivals and late departures.</p>
						...
						<p>In keeping with GoldenEye’s environmental philosophy, if you choose not to use the air conditioning during your stay, we will give you a rebate of US $20 per night, at the end of your stay.</p>
						
						
						<figure class="right dir" >
							<img src="<? echo get_bloginfo("stylesheet_directory") ?>/images/faq14.jpg" alt="Golden Eye" />
						</figure>				


						<h3>Safety-deposit boxes—are they in the room?</h3>
						<p>Yes, every room has a mini safe for your valuables and important documents - with two outlets where you can recharge electronic devices.</p>
						...
						<figure class="left esq">
							<img src="<? echo get_bloginfo("stylesheet_directory") ?>/images/faq15.jpg" alt="Golden Eye"/>
						</figure>
						...
						<p>The beautiful batik towels and the robes hanging in your closet are from Mary Vinson’s Royal Hut, founded by Mary Vinson Blackwell. You can purchase them in our gift shop or order them on the site <a href="http://www.royalhut.com" target="blank" title="Royal Rut">www.royalhut.com</a>, where you can also find our signature batik border towels, 400 thread count hand-dyed sheets, Nigerian-print place mats and other vibrantly patterned signatures of GoldenEye.</p>

						<figure class="right dir">
							<img src="<? echo get_bloginfo("stylesheet_directory") ?>/images/faq16.jpg" alt="Golden Eye" />
						</figure>
						...
						<p>Visit GoldenEye <a href="<? echo get_bloginfo("url") ?>/press" title="Press &amp; Awards">Press</a>.</p>
						...
						<div class="backTop clearfix">
							<a href="javascript:;" class="toTop">Back to Top</a>
						</div>
					</dd>

					
					<dt id="location"><span>Location &amp; Logistics</span></dt>
					<dd>
						<figure>
							<img src="<? echo get_bloginfo("stylesheet_directory") ?>/images/faq2.jpg" alt="Golden Eye"/>
						</figure>
						...
						<p>From Montego Bay: it takes about an hour and 30 minutes to get from Montego Bay Airport to GoldenEye.</p>

						<p>From Kingston: The drive from Kingston to GoldenEye takes about two hours. Again, we are happy to arrange your transportation.</p>
						...
						<p>There are several reliable car rental companies in Jamaica including Island Car Rentals, Avis and Hertz. Call the front desk to arrange. <a href="<? echo get_bloginfo("stylesheet_directory") ?>/downloads/Driving_Directions.pdf" target="_blank">Click</a> to print detailed driving instructions from all three airports to GoldenEye (and check out our picks for best places to stop along the way).</p>

						<figure>
							<img src="<? echo get_bloginfo("stylesheet_directory") ?>/images/faq3.jpg" alt="Golden Eye"/>
						</figure>

						<h3>From which cities can I fly direct to Jamaica?</h3>
						<p><b>From the U.S.:</b> Atlanta, Charlotte, Orlando, Baltimore / D.C. Metropolitan Area, Chicago, Miami, Boston, Fort Lauderdale, and New York. Plus you can also fly direct from Toronto, Canada.</p>
						<p><b>From Europe:</b> There are more direct daily flights between the U.K. and Jamaica than any other European city. Check for charter flights from: Vienna and Salzburg (Austria); Brussels (Belgium); Prague (Czech Republic); Copenhagen (Denmark); Marseilles and Paris (France); Dusseldorf, Frankfurt, Munich and Berlin (Germany); Athens (Greece); Budapest (Hungary); Milan and Rome (Italy); Amsterdam (Netherlands); Warsaw, Krakow and Gdansk (Poland); Lisbon and Porto (Portugal); Madrid, Bilbao and Barcelona (Spain); Geneva, Basel and Zurich (Switzerland); Moscow (Russia). </p>
						...
						<figure>
							<img src="<? echo get_bloginfo("stylesheet_directory") ?>/images/faq4.jpg" alt="Golden Eye"/>
						</figure>
						...
						<p>Oracabessa, St. Mary, Jamaica<br/>
							Tel: 876.6229.007 Fax: 876.622.9008<br/>
							E-mail: <a href="mailto:info@goldeneye.com?subject=Location and Logistic from Golden Eye Webpage" target="_blank">info@goldeneye.com</a></h3></p>
						...
						<figure>
							<img src="<? echo get_bloginfo("stylesheet_directory") ?>/images/faq5.jpg" alt="Golden Eye"/>
						</figure>
						...
						<p>We promise, you won’t feel anything but safe during your stay. Our staff loves GoldenEye, has worked here for years and call it their home. The town of Oracabessa, in which GoldenEye is located, is a lovely country town. Plus when you go off exploring the island, we’ll send you with a guide who’s on home turf.</p>

						<h3>Will I hear authentic Jamaican music in Oracabessa?</h3>
						<p>You bet! Not only do Jamaicans love their music, they love playing it loud! While you are staying at GoldenEye there is a good chance you’ll hear music playing from a local sound system. This may be disturbing if you are looking for complete and total silence. Then again, like us, you may love the unique soundtrack of the island and appreciate that music played on loud is very much a part of the culture.</p>
					...
					<dt id="activities"><span>Activities</span></dt>
					<dd>
						<figure>
							<img src="<? echo get_bloginfo("stylesheet_directory") ?>/images/faq6.jpg" alt="Golden Eye"/>
						</figure>
						...
						<figure class="left esq">
							<img src="<? echo get_bloginfo("stylesheet_directory") ?>/images/faq7.jpg" alt="Golden Eye"/>
						</figure>
						...
						<figure class="right dir">
							<img src="<? echo get_bloginfo("stylesheet_directory") ?>/images/faq8.jpg" alt="Golden Eye"/>
						</figure>					
					...
					<dt id="dining"><span>Dining</span></dt>
					<dd>
						<figure class="left esq">
							<img src="<? echo get_bloginfo("stylesheet_directory") ?>/images/faq9.jpg" alt="Golden Eye"/>
						</figure>
					...
					<p>If you have any special requests, specific dietary requirements or restrictions, just let us know.</p>
						...
						<figure class="right dir">
							<img src="<? echo get_bloginfo("stylesheet_directory") ?>/images/faq10.jpg" alt="Golden Eye"/>
						</figure>
						...
						<p>Whether you’re at the Bizot Bar or Gazebo bar, the sounds of laughter, chit-chat and deep dub reverb echo in the warm air.</p>

						<figure>
							<img src="<? echo get_bloginfo("stylesheet_directory") ?>/images/faq11.jpg" alt="Golden Eye"/>
						</figure>

						<p>Chances are, half the crowd will be holding a delicious combination of crushed ice, pineapple juice and rum called the GoldenEye (the same drink you were gratefully served upon your arrival). And the rum? Blackwell’s Fine Jamaican Rum. Now, how many hotels serve a rum “homemade” on property—by the proprietor?</p>

						<figure class="right dir">
							<img src="<? echo get_bloginfo("stylesheet_directory") ?>/images/faq12.jpg" alt="Golden Eye"/>
						</figure>
					...
					<dt id="owning"><span>Owning at GoldenEye</span></dt>
					<dd>
						...
						<p>Although the free hold title transfers the ownership of the land as well as the structure sitting on the land, property tax is based on the unimproved value of the land, resulting in nominal annual real estate taxes.</p>
					...
					<dt id="policies"><span>GoldenEye Policies</span></dt>
					<dd>
			...
			<aside class="left">
				...
				GoldenEye is located in Oracabessa Bay, in the parish of St. Mary, 20 minutes outside of Ocho Rios on the north coast of Jamaica.<br/>
				</p>
				...
				<p><span class="darkBlue"><strong>Airports:</strong></span><br/>
					...
					Montego Bay <em>(73 miles)</em></p>

				<p>Norman Manley International<br/>
					Kingston <em>(57 miles)</em></p>

				<p>Ian Fleming International / <br/>
					private aviation<br/>
					Boscobel <em>(2.7 miles)</em></p>
				...
				<p>Email<br/>
					<a href="mailto:info@goldeneye.com?subject=FAQ from Golden Eye Webpage" target="_blank">info@goldeneye.com</a></h3></p>
